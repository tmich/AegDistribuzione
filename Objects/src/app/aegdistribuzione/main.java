...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "app.aegdistribuzione", "app.aegdistribuzione.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "app.aegdistribuzione", "app.aegdistribuzione.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "app.aegdistribuzione.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static void killProgram() {
 ...
 {
            Activity __a = null;
            if (ordineactivity.previousOne != null) {
				__a = ordineactivity.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(ordineactivity.mostCurrent == null ? null : ordineactivity.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (schedaclienteactivity.previousOne != null) {
				__a = schedaclienteactivity.previousOne.get();
			}
            else {
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, starter.class));
 {
            Activity __a = null;
            if (loginactivity.previousOne != null) {
				__a = loginactivity.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(loginactivity.mostCurrent == null ? null : loginactivity.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (scaricadatiactivity.previousOne != null) {
				__a = scaricadatiactivity.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(scaricadatiactivity.mostCurrent == null ? null : scaricadatiactivity.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (dettaglioordineactivity.previousOne != null) {
				__a = dettaglioordineactivity.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(dettaglioordineactivity.mostCurrent == null ? null : dettaglioordineactivity.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (clientiactivity.previousOne != null) {
				__a = clientiactivity.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(clientiactivity.mostCurrent == null ? null : clientiactivity.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
RDebugUtils.currentLine=196609;
 //BA.debugLineNum = 196609;BA.debugLine="If Starter.User == Null Then";
if (mostCurrent._starter._user== null) { 
RDebugUtils.currentLine=196610;
 //BA.debugLineNum = 196610;BA.debugLine="StartActivity(LoginActivity)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._loginactivity.getObject()));
 };
RDebugUtils.currentLine=196612;
 //BA.debugLineNum = 196612;BA.debugLine="End Sub";
return "";
}
public static String  _btnarticoli_click() throws Exception{
RDebugUtils.currentModule="main";
...
RDebugUtils.currentLine=12910592;
 //BA.debugLineNum = 12910592;BA.debugLine="Sub btnArticoli_Click";
RDebugUtils.currentLine=12910593;
 //BA.debugLineNum = 12910593;BA.debugLine="StartActivity(ArticoliActivity)";
...
RDebugUtils.currentLine=12845056;
 //BA.debugLineNum = 12845056;BA.debugLine="Sub btnClienti_Click";
RDebugUtils.currentLine=12845057;
 //BA.debugLineNum = 12845057;BA.debugLine="StartActivity(ClientiActivity)";
...
RDebugUtils.currentLine=458752;
 //BA.debugLineNum = 458752;BA.debugLine="Sub ImageView3_Click";
RDebugUtils.currentLine=458753;
 //BA.debugLineNum = 458753;BA.debugLine="StartActivity(ScaricaDatiActivity)";
