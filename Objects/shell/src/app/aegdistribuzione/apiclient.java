...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"HttpUtils2Service",_ref.getField(false, "_httputils2service"),"m_job",_ref.getField(false, "_m_job"),"m_successo",_ref.getField(false, "_m_successo"),"m_url",_ref.getField(false, "_m_url")};
}
}